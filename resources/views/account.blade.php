                ...
                <div class="row">
                    ...
                    <div class="col-md-6 gx-5 mb-4">
                        ...
                        <div class="row row-cols-1 row-cols-md-3 g-4">
                            <div class="col">
                              <div class="card">
                                <img src="http://{{config('app.url')}}account/images/accountcc.png" class="card-img-top" alt="...">
                                <div class="card-body">
                                  <h5 class="card-title text-center"><a href="login/citizen" class="btn btn-primary">For Cabanatuan City Residents</a></h5>
                                  <p class="card-text text-center">Don't have an account? Register your account with the DOH Office.</p>
                                </div>
                              </div>
                            </div>
                            <div class="col">
                              <div class="card">
                                <img src="http://{{config('app.url')}}account/images/accountee.png" class="card-img-top" alt="...">
                                <div class="card-body">
                            ...
                            <div class="col">
                              <div class="card">
                                <img src="http://{{config('app.url')}}account/images/accountdoh.png" class="card-img-top" alt="...">
                                <div class="card-body">
